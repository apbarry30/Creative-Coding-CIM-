...
function preload(){
  ...
  //play function in the draw loop will mess it up. plays over on top of itsself ..we need to put it in a preload . this way it loads and plays seperate every time.
}
...
//loop through buttons and check if its been selected
//for (var i=0; i < buttonArray.length; i++){
//  if (buttonArray[i].check(mouseX, mouseY)){
//check which button we are overlay
